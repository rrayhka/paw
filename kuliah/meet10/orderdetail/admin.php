<?php 
    include "../koneksi.php";
    $query = mysqli_query($conn, "SELECT *, COUNT(order_id) AS jumlah_order, SUM(harga) AS total_harga FROM orders GROUP BY tanggal_order");
?>
            ...
            <tbody>
                <?php while($data = mysqli_fetch_assoc($query)){ ?>
                    <tr>
                        ...
                        <td>
                            <a href="detail.php?tanggal=<?=$data["tanggal_order"]?>" class="btn btn-primary">Detail</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
