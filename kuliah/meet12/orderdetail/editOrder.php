<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        $currentTimeWIB = $_POST["jam"];
        $currentDate = $_POST["tanggal"];
        $no = $_POST["nomor_meja"];
        $menu = $_POST["makanan"];
        ...
        $query = "UPDATE `orders` 
        SET `menu_id`='$menu_id2',
        `nama_pembeli`='$nama_pembeli',
        `makanan`='$menu',
        `harga`='$harga2',
        `tanggal_order`='$currentDate',
        `jam_order`='$currentTimeWIB',
        `nama_pelayan`='$pelayan',
        `nomor_meja`='$no' WHERE order_id = $orders_id_get";
