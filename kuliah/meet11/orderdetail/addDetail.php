<?php
    ...
    $queryTanggal = mysqli_query($conn, "SELECT * FROM orders WHERE tanggal_order = '$tanggal'");
    $querySubtotal = mysqli_query($conn, "SELECT * FROM order_detail ")
?>
...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php
                while($data = mysqli_fetch_assoc($queryTanggal)) {
                    echo "<tr>";
                    echo "<td>" . $data["order_id"] . "</td>";
                    echo "<td>" . $data["menu_id"] . "</td>";
