<?php
    include "../koneksi.php";
    $count = 1;
    $sort = isset($_GET['sort']) ? $_GET['sort'] : 'tanggal_order';
    $order = isset($_GET['order']) ? $_GET['order'] : 'asc';
    $sortDirection = ($order === 'asc') ? 'ASC' : 'DESC';
    $sql = "SELECT * FROM orders ORDER BY $sort $sortDirection";
            ...
            <tbody>
                <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $order_detail_query = "SELECT SUM(jumlah) AS jumlah_order, SUM(sub_total) AS total_harga FROM order_detail WHERE order_id = $order_id";
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $order_detail["total_harga"] ?></td>
                        <td>
