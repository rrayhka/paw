<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        $query = "INSERT INTO `orders` VALUES (NULL, '$currentDate', '$currentTimeWIB', '$pelayan', '$no')";
        mysqli_query($conn, $query);

        if($query) {
            $orders_id = mysqli_insert_id($conn);
            $subTotal = $qty * $harga2;
            $query = "INSERT INTO `order_detail` VALUES (NULL, '$orders_id', '$menu_id2', '$qty', '$harga2', '$subTotal')";
            mysqli_query($conn, $query);
            echo "<script>
